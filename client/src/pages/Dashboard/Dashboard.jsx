      ...
      <aside className="w-64 bg-[#F8FAFC] border-r border-slate-200 flex flex-col justify-between hidden md:flex shrink-0">
        <div className="p-6">
          ...
          <nav className="space-y-1">
            <a href="#" className="flex items-center gap-3 px-4 py-3 bg-white text-indigo-600 rounded-xl font-medium shadow-sm border border-slate-100">
        ...
        <header className="h-20 border-b border-slate-100 flex items-center justify-between px-8 bg-white shrink-0">
          <div className="relative w-96 group">
            ...
            <input 
              ...
              className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white transition-all"
            />
          </div>
